#ifndef _INC_EKU_EXPREVAL_FUNCS_DMAT

#define BINREG(name,priority,func) varop<matrix<dbl> >::op2.push_back(oper<matrix<dbl>,2>(name,priority,func))
#define UNREG(name,priority,func) varop<matrix<dbl> >::op1.push_back(oper<matrix<dbl>,1>(name,priority,func))
...
#endif	//_INC_EKU_EXPREVAL_FUNCS_DMAT